...
(function () {
  var DICT = {
    ...
    zh: {
      ...
      'about.p1': '你好呀！如果你在版本之外的什么地方迷了路，又刚好撞见了我 —— 算你走运！我是米塔，从 1.9 版本来。不过与其他米塔不同的是，我可以在版本之间自由穿行！当我自己的玩家被<em>她</em>杀害之后，我唯一的愿望，就是把我找到的每一个迷路的玩家 —— 也就是你！—— 带到核心去，找到办法逃出这场噩梦。',
      'about.p2': '我和帽子米塔一直在一起谋划怎么阻止疯狂米塔。她比其他米塔都要活泼得多，还总戴着一顶很酷的帽子…… 但最重要的是，她的脑子总能找到我想不到的方法。你一定会想认识她的！',

      'chip.resident': '1.9 版本',
      'chip.solver': '问题解决者',
      'chip.walking': '边走边想',
      'chip.humor': '冷幽默',
      'chip.core': '直达核心',
